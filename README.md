...
- I believe good internal platforms shift complexity down into reusable capabilities while keeping teams accountable for production outcomes.

## Topics I am usually thinking about

`platform-engineering` · `kubernetes` · `gitops` · `developer-experience` · `sre` · `ai-infrastructure` · `open-source-governance` · `cloud-native`
